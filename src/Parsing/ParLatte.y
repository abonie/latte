...
import Parsing.AbsLatte as AbsLatte
...
| 'class' Ident Ext CBody {
  (Just (tokenLineCol $1), AbsLatte.ClsDef (Just (tokenLineCol $1)) (snd $2)(snd $3)(snd $4)) 
}
...
: 'extends' Ident {
  (Just (tokenLineCol $1), AbsLatte.ExtSome (Just (tokenLineCol $1)) (snd $2)) 
}
| {
...
: Type Ident '(' ListArg ')' Block {
  (fst $1, AbsLatte.FunDef (fst $1)(snd $1)(snd $2)(snd $4)(snd $6)) 
}
...
CBody :: {
  (Maybe (Int, Int), CBody (Maybe (Int, Int)))
}
: '{' ListMemDecl '}' {
  (Just (tokenLineCol $1), AbsLatte.CBody (Just (tokenLineCol $1)) (reverse (snd $2)))
}

MemDecl :: {
  (Maybe (Int, Int), MemDecl (Maybe (Int, Int)))
}
: Type ListIdent ';' {
  (fst $1, AbsLatte.MemVar (fst $1)(snd $1)(snd $2)) 
}
| FunDef {
  (fst $1, AbsLatte.MemFun (fst $1)(snd $1)) 
}
...
| Ident {
  (fst $1, AbsLatte.TCls (fst $1)(snd $1)) 
}
| Type '[]' {
...
| 'new' Type '[' Expr ']' {
  (Just (tokenLineCol $1), AbsLatte.EArr (Just (tokenLineCol $1)) (snd $2)(snd $4)) 
}
| Ident '(' ListExpr ')' {
